...
Schwinn = Bicycle("Schwinn", 31, 300)
Huffy = Bicycle("Huffy", 33, 150)
Vilano = Bicycle("Vilano", 27, 515)
Diamondback = Bicycle("Diamondback", 25, 400)
Kestrel = Bicycle("Kestrel", 20, 1200)
Windsor = Bicycle("Windsor", 22, 600)
